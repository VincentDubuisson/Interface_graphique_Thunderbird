...
const qe = {
  ...
  fr: {
    ...
    tag: "Tag",
    icon: "Icône",
    tagsSeparate: "Séparez les tags par une virgule",
    iconsSeparate: "Séparez les icônes par une virgule",
    url: "URL"
  },
  ru: {
    font: "Цвет шрифта",
...
function Re(e) {
  ...
  return {
    c() {
      t = y("div"), n = y("div"), o = y("button"), o.textContent = "Style", i = L(), a = y("button"), c = L(), d = y("button"), d.textContent = "Image", f = L(), p && p.c(), l(o, "class", "svelte-o4eojs"), l(a, "class", s = "iconfont icon-" + /*isExpand*/
