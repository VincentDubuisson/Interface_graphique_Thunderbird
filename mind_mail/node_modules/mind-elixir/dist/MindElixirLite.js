...
function T({
  ...
  y.className += " mind-elixir", y.innerHTML = "", this.mindElixirBox = y, this.disposable = [], this.before = u || {}, this.locale = n || "en", this.contextMenuOption = r, this.contextMenu = i === void 0 ? !0 : i, this.toolBar = l === void 0 ? !0 : l, this.keypress = c === void 0 ? !0 : c, this.mouseSelectionButton = d || 0, this.direction = typeof t == "number" ? t : 1, this.draggable = o === void 0 ? !0 : o, this.newTopicName = a || "nouveau noeud", this.editable = s === void 0 ? !0 : s, this.allowUndo = f === void 0 ? !1 : f, this.currentNode = null, this.currentArrow = null, this.scaleVal = 1, this.tempDirection = null, this.generateMainBranch = p || hn, this.generateSubBranch = g || dn, this.overflowHidden = m || !1, this.bus = He.create(), this.container = q.createElement("div"), this.selectionContainer = h || this.container, this.container.className = "map-container";
