...
function gt(e, t) {
  ...
  }, i = Ce[e.locale] ? e.locale : "en", s = Ce[i], r = o("cm-add_child", s.addChild, "Tab"), c = o("cm-add_parent", s.addParent, "Ctrl + Enter"), l = o("cm-add_sibling", s.addSibling, "Enter"), d = o("cm-remove_child", s.removeNode, "Delete"), h = o("cm-fucus", s.focus, ""), u = o("cm-unfucus", s.cancelFocus, ""), a = o("cm-up", s.moveUp, "PgUp"), p = o("cm-down", s.moveDown, "Pgdn"), m = o("cm-link", s.link, ""), v = o("cm-link-bidirectional", "Lien bidirectionnel", ""), g = o("cm-summary", s.summary, ""), f = document.createElement("ul");
...
function D({
  ...
  b.className += " mind-elixir", b.innerHTML = "", this.mindElixirBox = b, this.disposable = [], this.before = u || {}, this.locale = n || "en", this.contextMenuOption = r, this.contextMenu = s === void 0 ? !0 : s, this.toolBar = c === void 0 ? !0 : c, this.keypress = l === void 0 ? !0 : l, this.mouseSelectionButton = d || 0, this.direction = typeof t == "number" ? t : 1, this.draggable = o === void 0 ? !0 : o, this.newTopicName = a || "nouveau noeud", this.editable = i === void 0 ? !0 : i, this.allowUndo = p === void 0 ? !1 : p, this.currentNode = null, this.currentArrow = null, this.scaleVal = 1, this.tempDirection = null, this.generateMainBranch = m || fo, this.generateSubBranch = v || po, this.overflowHidden = g || !1, this.bus = st.create(), this.container = Y.createElement("div"), this.selectionContainer = h || this.container, this.container.className = "map-container";
